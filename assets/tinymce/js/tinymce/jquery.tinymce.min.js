...
// Get editor instance
if(!o)return v()?v().get(l[0].id):null;l.css("vcontentbility","hidden");// Hide textarea to avoid flicker
...
n=v().createEditor(i,o),a.push(n),n.on("init",function(){var e,t=r;l.css("vcontentbility",""),
