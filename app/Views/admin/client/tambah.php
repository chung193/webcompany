		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group row">
					...
					<div class="col-4">
						<input type="text" name="telepon" class="form-control" placeholder="Điện thoại" value="<?= set_value('telepon') ?>">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-5">
						<input type="file" name="gambar" class="form-control" placeholder="Hình ảnh" value="<?= set_value('gambar') ?>">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-9">
						<textarea name="alamat" placeholder="Địa chỉ nhà" class="form-control"><?= set_value('alamat') ?></textarea>
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-9">
						<textarea name="isi_testimoni" placeholder="Lời chứng thực" class="form-control"><?= set_value('isi_testimoni') ?></textarea>
					</div>
				</div>
