...
<form action="<?= base_url('admin/history/add') ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
<?= csrf_field();
?>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group row">
					...
					<div class="col-9">
						<input type="text" name="time" class="form-control" placeholder="dd/mm/yyyy" required>
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-9">
						<textarea name="content" placeholder="Địa chỉ" class="form-control"></textarea>
					</div>
				</div>
